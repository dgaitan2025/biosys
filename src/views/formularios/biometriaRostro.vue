<template>
    <!-- FUNCIONALIDAD FACIAL DESHABILITADA: vista completa de verificación por rostro.
...
<script setup>
// FUNCIONALIDAD FACIAL DESHABILITADA: lógica completa de autenticación/verificación facial.
//
// import { ref } from 'vue'

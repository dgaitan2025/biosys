        ...
        data: [
            {
                ...
                // FUNCIONALIDAD FACIAL DESHABILITADA: fotografía de prueba RENAP no utilizada para enrolamiento.
...
const consultarRenap = async () => {
    try {
        ...
        // FUNCIONALIDAD FACIAL DESHABILITADA:
        // La fotografía de RENAP ya no se incorpora al enrolamiento ni se envía para biometría facial.
...
const guardar = async () => {
    try {
        ...
        // FUNCIONALIDAD FACIAL DESHABILITADA:
        // Se elimina de la validación la fotografía/rostro y se conserva únicamente la huella.
        // if (form.value.fotografia === null || form.value.huella === null || form.value.enrolamientos[0].imagen === "") {
        if (form.value.huella === null) {

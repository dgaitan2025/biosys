...
const cargarDatosParaActualizar = (data) => {
    ...
    // Se excluye cualquier registro facial existente para que no vuelva a enviarse en una actualización.
    const biometrias = Array.isArray(data?.biometrias)
        ? data.biometrias.filter(x => Number(x.id_caracteristica) !== 11)
        : []
